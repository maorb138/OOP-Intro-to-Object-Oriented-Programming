...
public class Velocity {
    ...
    /**
     * Instantiates a new around.Velocity.
     *
     * @param dx the dx
     * @param dy the dy
     */
    ...
    /**
     * around.Velocity - From angle and speed to velocity.
     * @param angle the angle
     * @param speed the speed
     * @return the velocity
     */
    public static Velocity fromAngleAndSpeed(double angle, double speed) {
        double dx1 = Math.sin(Math.toRadians(angle)) * speed;
        double dy1 = -1 * Math.cos(Math.toRadians(angle)) * speed;

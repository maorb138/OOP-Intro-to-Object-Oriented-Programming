...
public class CountdownAnimation implements Animation {
    ...
    public void doOneFrame(DrawSurface d) {
        ...
        d.drawText((WIDTH_SCR / 2) - 45, (HEIGHT_SCR / 2) + 20, String.valueOf(countFrom), 80);
    ...
    /**
     * letsGo- print a txt on screen.
     *
     * @param d the DrawSurface
     */
    public void letsGo(DrawSurface d) {
        String txt = "GO!!!";
        d.setColor(new Color(100, 80, 50));
        d.drawText((WIDTH_SCR / 2) - 90, (HEIGHT_SCR / 2) + 100, txt, 80);
    }
